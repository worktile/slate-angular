...
describe("Editable Component", () => {
  ...
  it("should rerender when data reference changes", fakeAsync(() => {
    ...
    flush();
    fixture.detectChanges();
    let paragraphElement = document.querySelector(
    ...
    flush();
    fixture.detectChanges();
    let newParagraphElement = document.querySelector(
      '[data-slate-node="element"]'
    );
  ...
  it("should use default logic to show placeholder when set placeholder value", fakeAsync(() => {
    ...
    flush();
    fixture.detectChanges();
    const placeholderLeaf = document.querySelector(
    ...
    flush();
    fixture.detectChanges();
    let placeholderLeafWithComposition = document.querySelector(
      '[data-slate-placeholder="true"]'
    );
    ...
    flush();
    fixture.detectChanges();
    let placeholderLeafWithContent = document.querySelector(
      '[data-slate-placeholder="true"]'
    );
