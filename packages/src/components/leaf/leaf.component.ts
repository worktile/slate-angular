...
export class SlateLeafComponent
  extends ViewContainerItem<SlateLeafContext, BaseLeafComponent>
  ...
  getViewType(): ViewType {
    return (
      (this.viewContext.renderLeaf &&
        this.viewContext.renderLeaf(this.context.leaf)) ||
