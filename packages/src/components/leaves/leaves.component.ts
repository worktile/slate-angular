...
export class SlateLeavesComponent extends ViewContainer<SlateLeafComponent>
  ...
  ngOnChanges(simpleChanges: SimpleChanges) {
    ...
    if (
      ...
      !isDecoratorRangeListEqual(
        previousValue.decorations,
        currentValue.decorations
      )
    ) {
      this.leaves = Text.decorations(
        this.context.text,
